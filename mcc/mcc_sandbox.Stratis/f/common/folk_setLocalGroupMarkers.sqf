...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		...
		["GrpNO_MAA1", 3, "MAA1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpNO_SF1", 4, "SF1", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpNO_SF2", 4, "SF2", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpNO_SN1", 4, "SN1", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpNO_SN2", 4, "SN2", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpNO_ART1", 3, "ART1", "ColorGreen"] spawn fnc_folk_localGroupMarker;
...
// Markers seen by players in Iran slots.
	...
	case "opf_f":
	{
		...
		["GrpIR_MAA1", 3, "MAA1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpIR_SF1", 4, "SF1", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpIR_SF2", 4, "SF2", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpIR_SN1", 4, "SN1", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpIR_SN2", 4, "SN2", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpIR_ART1", 3, "ART1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
...
// 		["GrpIR_TH2",  8, "TH2", "ColorOrange"] spawn fnc_folk_localGroupMarker;
	...
	case "ind_f":
	{
		["GrpGR_CO", 0, "CO", "ColorYellow"] spawn fnc_folk_localGroupMarker;
		["GrpGR_DC", 0, "DC", "ColorYellow"] spawn fnc_folk_localGroupMarker;
		["GrpGR_ASL", 0, "ASL", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpGR_A1", 1, "A1", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpGR_A2", 1, "A2", "ColorRed"] spawn fnc_folk_localGroupMarker;		
		["GrpGR_A3", 1, "A3", "ColorRed"] spawn fnc_folk_localGroupMarker;		
		["GrpGR_BSL", 0, "BSL", "ColorBlue"] spawn fnc_folk_localGroupMarker;
		["GrpGR_B1", 1, "B1", "ColorBlue"] spawn fnc_folk_localGroupMarker;
		["GrpGR_B2", 1, "B2", "ColorBlue"] spawn fnc_folk_localGroupMarker;
		["GrpGR_B3", 1, "B3", "ColorBlue"] spawn fnc_folk_localGroupMarker;
		["GrpGR_CSL", 0, "CSL", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpGR_C1", 1, "C1", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpGR_C2", 1, "C2", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpGR_C3", 1, "C3", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpGR_MMG1", 2, "MMG1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpGR_MAT1", 3, "MAT1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpGR_MAA1", 3, "MAA1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpGR_SF1", 4, "SF1", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpGR_SF2", 4, "SF2", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpGR_SN1", 4, "SN1", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpGR_SN2", 4, "SN2", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpGR_ENG1",  6, "ENG1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpGR_TH1",  8, "TH1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpGR_AH1",  8, "AH1", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpGR_DT1",  4, "DT1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpGR_ART1", 3, "ART1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpGR_IFV1",  7, "IFV1", "ColorRed"] spawn fnc_folk_localGroupMarker;
 		["GrpGR_IFV2",  7, "IFV2", "ColorBlue"] spawn fnc_folk_localGroupMarker;	
 		["GrpGR_IFV3",  7, "IFV3", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		
		["UnitGR_CO_M", 0, "COM", "ColorBlack"] spawn fnc_folk_localSpecialistMarker;
		["UnitGR_DC_M", 0, "DCM", "ColorBlack"] spawn fnc_folk_localSpecialistMarker;
		["UnitGR_ASL_M", 0, "AM", "ColorBlack"] spawn fnc_folk_localSpecialistMarker;		
		["UnitGR_BSL_M", 0, "BM", "ColorBlack"] spawn fnc_folk_localSpecialistMarker;
		["UnitGR_CSL_M", 0, "CM", "ColorBlack"] spawn fnc_folk_localSpecialistMarker;
	};
};
