...

{
	if ( leader _x == _x ) then {
		_x addaction ["Order your men to follow me", MCC_path + "scripts\actions\followme.sqf", [], 1, false];
	} else {
		_x addaction ["Follow me", MCC_path + "scripts\actions\followme.sqf", [], 1, false];
	};
}foreach _soldiers;	
