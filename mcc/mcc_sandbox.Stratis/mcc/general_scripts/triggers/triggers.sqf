   ...
   case 0:	//Mapclick Generate
	...
	{ 
		...
		mcc_safe = mcc_safe + FORMAT ["
							MCC_capture_var = '%7';
							script_handler = [0, %1, %2, '%3', '%4', '%5', '%6', MCC_capture_var] execVM '"+MCC_path+"mcc\general_scripts\triggers\triggers_execute.sqf';
		...
		[0, _pos, _size, _activate, _cond, Mshape, _text, MCC_capture_var] execVM MCC_path + "mcc\general_scripts\triggers\triggers_execute.sqf";
		closedialog 3000;
		waituntil {!dialog};
