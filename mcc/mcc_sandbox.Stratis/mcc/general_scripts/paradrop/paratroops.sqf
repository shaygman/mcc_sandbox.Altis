...
_heli 				= [_heliType, _spawn, _pos, 200, false] call MCC_CREATE_PLANE;		
...
_cargoUnits = [];
if (_cargoNum > 0) then	{
	_unitsArray	= [faction _heli,"soldier","men"] call FNC_MAKE_UNITS_ARRAY;	//Let's build the faction unit's array
