private ["_type","_d","_RainLevel","_waves","_lightning","_cloudLevel","_weather","_footer","_x", "_html", "_loop","_wind","_fog"];
...
switch (_type) do
{
   ...
   case 1:
   {
	   ...
	   [[2,compile format ["MCC_sync = '%1'; mcc_missionmaker = '%2'; mcc_sync_status = true;",MCC_sync, mcc_missionmaker]], "MCC_fnc_globalExecute", true, false] spawn BIS_fnc_MP;
	};
 };
