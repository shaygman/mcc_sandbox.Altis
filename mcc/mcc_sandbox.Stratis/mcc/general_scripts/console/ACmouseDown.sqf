		...
		switch (MCC_ConsoleACweaponSelected) do {
			...
			case 0: {
				...
				while {!MCC_consoleACmousebuttonUp && (MCC_ConsoleACAmmo select 0) >0} do {
					...
					playSound "gun1";
					[[netid MCC_fakeAC, "gun1"], "MCC_fnc_globalSay3D", true, false] spawn BIS_fnc_MP;
			...
			case 1: {
				...
				while {!MCC_consoleACmousebuttonUp && (MCC_ConsoleACAmmo select 1) >0} do {
					...
					playSound "gun2";
					[[netid MCC_fakeAC, "gun2"], "MCC_fnc_globalSay3D", true, false] spawn BIS_fnc_MP;
			...
			case 2: {
				...
				playSound "gun3";
				[[netid MCC_fakeAC, "gun3"], "MCC_fnc_globalSay3D", true, false] spawn BIS_fnc_MP;
