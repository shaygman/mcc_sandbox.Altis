...
private ["_type","_string","_exe","_markerstr","_text","_stringName"];
...
switch (_type) do
{
   ...
   case 1:	//Set task destination
   {
	...
	[["TaskAssigned",[_stringName,_stringName]], "bis_fnc_showNotification", true, false] spawn BIS_fnc_MP;	sleep 3; 
	...
	MCC_sync=MCC_sync + FORMAT ["_type			=%1;
							...
							_markerstr setMarkerShape 'mil_objective';
							_stringName setMarkerType 'Warning';
							[['TaskAssigned',[_stringName,_stringName]], 'bis_fnc_showNotification', true, false] spawn BIS_fnc_MP;
							sleep 2;
							[_pos,_text,200,200,180,0,[]] spawn BIS_fnc_establishingShot;
							sleep 5;
							"								 
