/*==================================================================MCC_fnc_loadServer===============================================================================================
	Load persistent data about the server to the server

	<IN>
		0		: STRING file name - MCC will always add world name
		1		: INTEGER wait time between each save
		2		: BOOLEAN Load tiles usualy for campaign
		3		: BOOLEAN Load tickets for each side
		4		: BOOLEAN Load resources
		5		: BOOLEAN Load civilian relation
		6		: BOOLEAN Load commander's CAS
		7		: BOOLEAN Load commander's air drop
		8		: BOOLEAN Load commander's artillery
		9		: BOOLEAN Load Start locations
		10		: BOOLEAN Load RTS Buildings
