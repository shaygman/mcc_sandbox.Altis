...
//===========================================================================================================================================================================	
private ["_utility","_vel","_dir","_handPos","_item","_mag","_itemClass","_charges"];
_primaryMod = _this select 0;
_item 		= ((player getVariable ["MCC_utilityItem",[objnull,objnull]]) select 0);
if (isNull _item && _primaryMod) exitWith {};
...
_mag		= (player getVariable ["MCC_utilityItem",[objnull,objnull]]) select 1;
