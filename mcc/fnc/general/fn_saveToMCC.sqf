...
_tempArray = [
                ...
                missionNamespace getvariable ["MCC_ConsoleOnlyShowUnitsWithGPS",true],
                missionNamespace getvariable ["MCC_ConsoleDrawWP",true],
                missionNamespace getvariable ["MCC_ConsolePlayersCanSeeWPonMap",true],
                missionNamespace getvariable ["MCC_ConsoleCanCommandAI",true],
                missionNamespace getvariable ["MCC_nameTags",false],
                missionNamespace getvariable ["MCC_saveGear",true],
                missionNamespace getvariable ["MCC_groupMarkers",true],
                missionNamespace getvariable ["MCC_Chat",true],
                missionNamespace getvariable ["MCC_GAIA_AMBIANT",true],
                ...
                missionNamespace getvariable ["MCC_deletePlayersBody",true],
                missionNamespace getvariable ["MCC_interaction",true],
                missionNamespace getvariable ["MCC_surviveMod",false],
                missionNamespace getvariable ["MCC_cover",true],
                missionNamespace getvariable ["MCC_coverUI",true],
                missionNamespace getvariable ["MCC_changeRecoil",true],
                missionNamespace getvariable ["MCC_coverVault",true],
                missionNamespace getvariable ["MCC_quickWeaponChange",false],
                missionNamespace getvariable ["MCC_ingameUI",true]
             ];
MCC_output = MCC_output + format ["%1",_tempArray];
