...
switch (_task) do
{
   ...
   case "Secure_HVT":      
   {
      ...
      _stringDescription =  FORMAT ["Task: Rescue %2. <br/><br/>%1 %2 was captured by enemy forces operating in the area.<br/><br/>%3 we believe that he is held captive %4.<br/><br/>Find %2 and bring him home.                              
                              "
   ...
   case "Kill_HVT":      
   {
      ...
      _stringDescription =  FORMAT ["Task: Kill or capture %2. <br/><br/>%3, HQ in their wisdom believe that since %1 %2 has been hiding %4.<br/><br/>%2 is a most wanted HVT and should be considered armed and dangerous.<br/><br/>Capture him if possible, if not kill him. Either way, do not let him escape."
                             , _missionTime call BIS_fnc_selectRandom
                             , _objectName
                             , _missionIntel call BIS_fnc_selectRandom
                             , _missionWherabouts call BIS_fnc_selectRandom
   ...
   case "destroy_tanks":      
   {
      ...
      _stringDescription =  FORMAT ["Task: Destroy the prototype %2.<br/><br/>%1 HQ received intel suggesting that the enemy has obtained a prototype %2.<br/><br/>This is a game-changer and we must eliminate it by any means necessary.<br/>%3 the vehicle is hidden %4."
                             , _missionTime call BIS_fnc_selectRandom
                             , _objectName
                             , _missionIntel call BIS_fnc_selectRandom
                             , _missionWherabouts call BIS_fnc_selectRandom
   ...
   case "destroy_aa":      
   {
      ...
      _stringDescription =  FORMAT ["Task: Destroy %2.<br/><br/>%1 one of our planes got shot down.<br/>HQ believes that a %2 is behind it.<br/><br/>This threat must be eliminated.<br/><br/>%3 the AA is operating %4. Find and destroy it, soldier."
                             , _missionTime call BIS_fnc_selectRandom
                             , _objectName
                             , _missionIntel call BIS_fnc_selectRandom
                             , _missionWherabouts call BIS_fnc_selectRandom
   ...
   case "destroy_artillery":      
   {
      _objectName = getText(configFile >> "CfgVehicles" >> typeof _obj >> "displayname");
      _stringName   = FORMAT ["%2 Destroy %1", _objectName,_nameTask];
      _stringDescription =  FORMAT ["Task: Destroy %2.<br/><br/>%1 enemy artillery began pounding our troops. This threat must be eliminated.<br/><br/>%3 the %2 is operating %4.<br/><br/>Find and destroy it ASAP."
                             , _missionTime call BIS_fnc_selectRandom
                             , _objectName
                             , _missionIntel call BIS_fnc_selectRandom
                             , _missionWherabouts call BIS_fnc_selectRandom
   ...
   case "destroy_cache":      
   {
      ...
      _stringDescription =  FORMAT ["Task: Destroy the enemy weapons cache.<br/><br/>%2 received %1, we believe that the enemy is hiding a weapons cache %3.<br/><br/>Destroying it will severely damage the enemy war effort.<br/><br/>Find and destroy it ASAP."
                             , _missionTime call BIS_fnc_selectRandom
                             , _missionIntel call BIS_fnc_selectRandom
                             , _missionWherabouts call BIS_fnc_selectRandom
                             , _stringName
   ...
   case "destroy_fuel":      
   {
      ...
      _stringDescription =  FORMAT ["Task: Destroy the enemy fuel depot.<br/><br/>%2 received %1, we believe that the enemy have a fuel depot %3.<br/><br/>Destroying it will severely damage the enemy war effort.<br/><br/>Find and destroy it ASAP."
                             , _missionTime call BIS_fnc_selectRandom
                             , _missionIntel call BIS_fnc_selectRandom
                             , _missionWherabouts call BIS_fnc_selectRandom
                             , _stringName
   ...
   case "destroy_radio":      
   {
      ...
      _stringDescription =  FORMAT ["Task: Destroy the enemy radio tower.<br/><br/>%2 received %1 the enemy have a radio tower %3. They are using it to coordinate their attacks.<br/><br/>Destroying it will severely damage the enemy war effort.<br/><br/>Find and destroy it ASAP."
                             , _missionTime call BIS_fnc_selectRandom
                             , _missionIntel call BIS_fnc_selectRandom
                             , _missionWherabouts call BIS_fnc_selectRandom
                             , _stringName
   ...
   case "destroy_radar":      
   {
      ...
      _stringDescription =  FORMAT ["Task: Destroy the enemy radar.<br/><br/>%2 received %1 the enemy have a radar installation %3. They are using it to pinpoint the location of our troops.<br/><br/>By destroying it we can regain the element of surprise.<br/><br/>Find and destroy it ASAP."
                             , _missionTime call BIS_fnc_selectRandom
                             , _missionIntel call BIS_fnc_selectRandom
                             , _missionWherabouts call BIS_fnc_selectRandom
                             , _stringName
   ...
   case "pick_intel":      
   {
      ...
      _stringDescription =  FORMAT ["Task: Acquire Intel.<br/><br/>HQ believe that we have an opportunity to acquire top notch information about enemy forces operating in the area.<br/><br/>%3 the target data is in a %2, located %4.<br/><br/>Retrieve the information and bring it back for analysis."
                             , _missionTime call BIS_fnc_selectRandom
                             , _objectName
                             , _missionIntel call BIS_fnc_selectRandom
                             , _missionWherabouts call BIS_fnc_selectRandom
   ...
   case "clear_area":      
   {
      ...
      _stringDescription =  FORMAT ["Task: Capture and Hold.<br/><br/>%1 enemy forces established a foothold %2.<br/><br/>We can not allow this to continue!<br/><br/>Go there and kick them out!!"
                             , _missionTime call BIS_fnc_selectRandom
                             , _missionWherabouts call BIS_fnc_selectRandom
                             , _stringName
                             ];
   ...
   case "disableIED":   
   {
      ...
      _stringDescription =  FORMAT ["Task: Disable IED.<br/><br/>%1 enemy forces have placed a massive Improvised Explosive Device (IED) on a road %2.<br/><br/>We must disable it before it can cause any damage.<br/><br/>Tread carefully, find the IED and disarm it."   
                             , _missionIntel call BIS_fnc_selectRandom
                             , _missionWherabouts call BIS_fnc_selectRandom
                             , _stringName
                             ];
