...
//Self Interaction
["MCC", "selfInteraction", ["Interaction Self", ""], {if ((missionNameSpace getVariable ["MCC_interaction",false]) && (player getVariable ["cpReady",true]) && !(player getvariable ["MCC_medicUnconscious",false])) then {[player] spawn MCC_fnc_interactSelf;true}}, {}, [219, [false,true,false]],false] call cba_fnc_addKeybind;
