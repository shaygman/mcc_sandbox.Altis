...
class MCC_rts_hq2 : MCC_rts_hq1
{
	...
	level = 2;
	resources[] = {{"ammo",200},{"repair",500},{"food",300},{"time",1}};
	actionFNC = "MCC_fnc_baseActionClicked";
...
class MCC_rts_hq3 : MCC_rts_hq2
{
	...
	upgradeTo[] = {};
	level = 3;
	resources[] = {{"ammo",400},{"repair",700},{"food",500},{"time",1}};
...
class MCC_rts_barracks1
{
	...
	constType = "barracks";
	level = 1;
	resources[] = {{"repair",100},{"food",200},{"med",100},{"time",1}};
	actionFNC = "MCC_fnc_baseActionClicked";
...
class MCC_rts_barracks2 : MCC_rts_barracks1
{
	...
	constType = "barracks";
	level = 2;
	resources[] = {{"repair",200},{"food",300},{"med",100},{"time",1}};
...
class MCC_rts_barracks3 : MCC_rts_barracks1
{
	...
	constType = "barracks";
	level = 3;
	resources[] = {{"repair",300},{"food",400},{"med",100},{"time",1}};
...
class MCC_rts_workshop1
{
	...
	constType = "workshop";
	level = 1;
	resources[] = {{"ammo",100},{"repair",300},{"fuel",100},{"time",1}};
	actionFNC = "MCC_fnc_baseActionClicked";
...
class MCC_rts_workshop2 : MCC_rts_workshop1
{
	...
	upgradeTo[] = {};
	level = 2;
	resources[] = {{"ammo",200},{"repair",300},{"fuel",200},{"time",1}};
	actionFNC = "MCC_fnc_baseActionClicked";
...
class MCC_rts_workshop3 : MCC_rts_workshop2
{
	...
	upgradeTo[] = {};
	level = 3;
	resources[] = {{"ammo",400},{"repair",400},{"fuel",400},{"time",1}};
...
class MCC_rts_workshop4 : MCC_rts_workshop2
{
	...
	upgradeTo[] = {};
	level = 4;
	resources[] = {{"ammo",800},{"repair",500},{"fuel",800},{"time",1}};
...
class MCC_rts_workshop5 : MCC_rts_workshop2
{
	...
	upgradeTo[] = {};
	level = 5;
	resources[] = {{"ammo",1000},{"repair",600},{"fuel",1000},{"time",1}};
...
class MCC_rts_elecPower1
{
	...
	constType = "elecPower";
	level = 1;
	resources[] = {{"repair",300},{"fuel",200},{"time",1}};
	actionFNC = "MCC_fnc_baseActionClicked";
...
class MCC_rts_elecPower2 : MCC_rts_elecPower1
{
	...
	constType = "elecPower";
	level = 2;
	resources[] = {{"repair",400},{"fuel",300},{"time",1}};
...
class MCC_rts_elecPower3 : MCC_rts_elecPower1
{
	...
	constType = "elecPower";
	level = 3;
	resources[] = {{"repair",800},{"fuel",200},{"time",1}};
...
class MCC_rts_triage1
{
	...
	constType = "triage";
	level = 1;
	resources[] = {{"repair",300},{"food",100},{"med",300},{"time",1}};
	actionFNC = "MCC_fnc_baseActionClicked";
	objectsArray[] =  {};
};
...
class MCC_rts_triage2
{
	...
	constType = "triage";
	level = 2;
	resources[] = {{"repair",600},{"food",200},{"med",600},{"time",1}};
	actionFNC = "MCC_fnc_baseActionClicked";
	objectsArray[] =  {};
};
