...
class MCC_antibiotics : CA_Magazine
{
	scope = 2;
...
class MCC_firstAidKit : MCC_antibiotics
{
	...
	descriptionShort = "Stick and stones may break your bones but bullets break them better";
...
class MCC_ductTape : CA_Magazine
{
	scope = 2;
...
class MCC_butanetorch : CA_Magazine
{
	scope = 2;
...
class MCC_metalwire : CA_Magazine
{
	scope = 2;
...
class MCC_foodcontainer : CA_Magazine
{
	scope = 2;
...
class MCC_cerealbox : CA_Magazine
{
	scope = 2;
