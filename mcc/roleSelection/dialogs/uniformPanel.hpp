class CP_UNIFORMSPANEL {
	  idd = -1;
	  movingEnable = false;
	  onLoad =  __EVAL("_this execVM '"+CPPATH+"mcc\roleSelection\scripts\uniformsPanel_init.sqf'");
	...
	class CP_uniformPanelNV: CP_RscCombo
	{
		...
		sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		onLBSelChanged = __EVAL("[0] execVM '"+CPPATH+"mcc\roleSelection\scripts\uniformPanel_cmd.sqf'");
	};
	class CP_uniformPanelHead: CP_RscCombo
	{
		...
		h = 0.0659743 * safezoneH;
		sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		onLBSelChanged = __EVAL("[1] execVM '"+CPPATH+"mcc\roleSelection\scripts\uniformPanel_cmd.sqf'");
	};
	class CP_uniformPanelGoggles: CP_RscCombo
	{
		...
		h = 0.0659743 * safezoneH;
		sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		onLBSelChanged = __EVAL("[2] execVM '"+CPPATH+"mcc\roleSelection\scripts\uniformPanel_cmd.sqf'");
	};
	class CP_uniformPanelVest: CP_RscCombo
	{
		...
		h = 0.0659743 * safezoneH;
		sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		onLBSelChanged = __EVAL("[3] execVM '"+CPPATH+"mcc\roleSelection\scripts\uniformPanel_cmd.sqf'");
	};
	class CP_uniformPanelBackpack: CP_RscCombo
	{
		...
		h = 0.0659743 * safezoneH;
		sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		onLBSelChanged = __EVAL("[4] execVM '"+CPPATH+"mcc\roleSelection\scripts\uniformPanel_cmd.sqf'");
	};
	class CP_uniformPanelUniforms: CP_RscCombo
	{
		...
		h = 0.0659743 * safezoneH;
		sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		onLBSelChanged = __EVAL("[5] execVM '"+CPPATH+"mcc\roleSelection\scripts\uniformPanel_cmd.sqf'");
	};
