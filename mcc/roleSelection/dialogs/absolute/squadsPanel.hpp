class CP_SQUADPANEL {
	  idd = -1;
	  movingEnable = false;
	  onLoad =  __EVAL("_this execVM '"+CPPATH+"mcc\roleSelection\scripts\squadPanel_init.sqf'");
	  ...
	  controls[] =
	  {
		...
		class CP_squadPanelSquadList: CP_RscListbox
		{
			...
			onLBSelChanged = __EVAL("[0] execVM '"+CPPATH+"mcc\roleSelection\scripts\squadPanel_cmd.sqf'");
		...
		class CP_squadPanelPlayersList: CP_RscListbox
		{
			...
			colorBackground[] = {0,0,0,0.7};
			onLBSelChanged = __EVAL("[4] execVM '"+CPPATH+"mcc\roleSelection\scripts\squadPanel_cmd.sqf'");
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		};
		...
		class CP_squadPanelJoinButton: CP_RscButtonMenu
		{
			...
			w = 0.0973958 * safezoneW;
			h = 0.0439828 * safezoneH;
			action = __EVAL("[1] execVM '"+CPPATH+"mcc\roleSelection\scripts\squadPanel_cmd.sqf'");
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		};
		class CP_squadPanelSwitchSidesButton: CP_RscButtonMenu
		{
			...
			action = __EVAL("[2] execVM '"+CPPATH+"mcc\roleSelection\scripts\squadPanel_cmd.sqf'");
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		};
		...
		class CP_squadPanelCreateSquadButton: CP_RscButtonMenu
		{
			...
			action = __EVAL("[3] execVM '"+CPPATH+"mcc\roleSelection\scripts\squadPanel_cmd.sqf'");
		...
		class CP_tittle: CP_RscPicture
		{
			...
			text = __EVAL(CPPATH+"mcc\roleSelection\data\chockpoints.paa");
		};
		...
		class CP_LockSquad: CP_RscButtonMenu
		{
			idc = -1;
			colorBackground[] = {0,0,0,0};
			action =  __EVAL("[5] execVM '"+CPPATH+"mcc\roleSelection\scripts\squadPanel_cmd.sqf'");
		...
		{
			idc = 15;
			action =  __EVAL("[6] execVM '"+CPPATH+"mcc\roleSelection\scripts\squadPanel_cmd.sqf'");
		...
		{
			idc = 17;
			action =  __EVAL("[7] execVM '"+CPPATH+"mcc\roleSelection\scripts\squadPanel_cmd.sqf'");
		...
		class CP_respawnPanelRoleCombo: CP_RscCombo
		{
			...
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
			//onLBSelChanged = __EVAL("[2] execVM '"+CPPATH+"mcc\roleSelection\scripts\respawnPanel_cmd.sqf'");
		};
