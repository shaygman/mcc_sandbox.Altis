class CP_WEAPONSPANEL {
	  idd = -1;
	  movingEnable = false;
	  onLoad =  __EVAL("_this execVM '"+CPPATH+"mcc\roleSelection\scripts\weaponsPanel_init.sqf'");
	...
	class CP_weaponsPanelPrimary: CP_RscCombo
	{
		...
		sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		onLBSelChanged = __EVAL("[0] execVM '"+CPPATH+"mcc\roleSelection\scripts\weaponsPanel_cmd.sqf'");
	};
	class CP_weaponsPanelPrimaryAccessories: CP_RscButtonMenu
	{
		...
		action = __EVAL("[3] execVM '"+CPPATH+"mcc\roleSelection\scripts\switchDialog.sqf'");
	};
	class CP_weaponsPanelSecondary: CP_RscCombo
	{
		...
		colorBackground[] = {0,0,0,0.8};
		sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		onLBSelChanged = __EVAL("[1] execVM '"+CPPATH+"mcc\roleSelection\scripts\weaponsPanel_cmd.sqf'");
	};
	class CP_weaponsPanelHandgun: CP_RscCombo
	{
		...
		colorBackground[] = {0,0,0,0.8};
		sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		onLBSelChanged = __EVAL("[2] execVM '"+CPPATH+"mcc\roleSelection\scripts\weaponsPanel_cmd.sqf'");
	};
	class CP_weaponsPanelItem1: CP_RscCombo
	{
		...
		colorBackground[] = {0,0,0,0.8};
		sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		onLBSelChanged = __EVAL("[3] execVM '"+CPPATH+"mcc\roleSelection\scripts\weaponsPanel_cmd.sqf'");
	};
	class CP_weaponsPanelItem2: CP_RscCombo
	{
		...
		colorBackground[] = {0,0,0,0.8};
		sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		onLBSelChanged = __EVAL("[4] execVM '"+CPPATH+"mcc\roleSelection\scripts\weaponsPanel_cmd.sqf'");
	};
	class CP_weaponsPanelItem3: CP_RscCombo
	{
		...
		colorBackground[] = {0,0,0,0.8};
		sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		onLBSelChanged = __EVAL("[5] execVM '"+CPPATH+"mcc\roleSelection\scripts\weaponsPanel_cmd.sqf'");
	};
