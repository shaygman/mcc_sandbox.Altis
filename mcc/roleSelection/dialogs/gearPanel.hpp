class CP_GEARPANEL {
		...
		class CP_gearPanelCommander: CP_RscButton
	{
		...
		{
			idc = -1;
			text = __EVAL(MCCPATH+"mcc\roleSelection\data\Officer.paa");
	...
	class CP_gearPanelAR: CP_RscButton
	{
		...
		{
			idc = -1;
			text = __EVAL(MCCPATH+"mcc\roleSelection\data\AR.paa");
			x = 0.154531 * safezoneW + safezoneX;
			y = 0.335064 * safezoneH + safezoneY;
			w = 0.05 * safezoneW;
			h = 0.044 * safezoneH;
	...
	class CP_gearPanelRifleman: CP_RscButton
	{
		...
		{
			idc = -1;
			text = __EVAL(MCCPATH+"mcc\roleSelection\data\Rifleman.paa");
			x = 0.154531 * safezoneW + safezoneX;
			y = 0.390043 * safezoneH + safezoneY;
			w = 0.05 * safezoneW;
			h = 0.044 * safezoneH;
	...
	class CP_gearPanelAntitank: CP_RscButton
	{
		...
		{
			idc = -1;
			text = __EVAL(MCCPATH+"mcc\roleSelection\data\AT.paa");
			x = 0.154531 * safezoneW + safezoneX;
			y = 0.445021 * safezoneH + safezoneY;
			w = 0.05 * safezoneW;
			h = 0.044 * safezoneH;
	...
	class CP_gearPanelCorpsman: CP_RscButton
	{
		...
		{
			idc = -1;
			text = __EVAL(MCCPATH+"mcc\roleSelection\data\Corpsman.paa");
			x = 0.154531 * safezoneW + safezoneX;
			y = 0.5 * safezoneH + safezoneY;
			w = 0.05 * safezoneW;
			h = 0.044 * safezoneH;
	...
	class CP_gearPanelMarksman: CP_RscButton
	{
		...
		{
			idc = -1;
			text = __EVAL(MCCPATH+"mcc\roleSelection\data\Marksman.paa");
			x = 0.154531 * safezoneW + safezoneX;
			y = 0.554979 * safezoneH + safezoneY;
			w = 0.05 * safezoneW;
			h = 0.044 * safezoneH;
	...
	class CP_gearPanelSpecialist: CP_RscButton
	{
		...
		{
			idc = -1;
			text = __EVAL(MCCPATH+"mcc\roleSelection\data\Specialist.paa");
			x = 0.154531 * safezoneW + safezoneX;
			y = 0.609957 * safezoneH + safezoneY;
			w = 0.05 * safezoneW;
			h = 0.044 * safezoneH;
	...
	class CP_gearPanelCrewman: CP_RscButton
	{
		...
		{
			idc = -1;
			text = __EVAL(MCCPATH+"mcc\roleSelection\data\Crew.paa");
			x = 0.154531 * safezoneW + safezoneX;
			y = 0.664936 * safezoneH + safezoneY;
			w = 0.05 * safezoneW;
			h = 0.044 * safezoneH;
	...
	class CP_gearPanelPilot: CP_RscButton
	{
		...
		{
			idc = -1;
			text = __EVAL(MCCPATH+"mcc\roleSelection\data\Pilot.paa");
			x = 0.154531 * safezoneW + safezoneX;
			y = 0.719914 * safezoneH + safezoneY;
			w = 0.05 * safezoneW;
			h = 0.044 * safezoneH;
