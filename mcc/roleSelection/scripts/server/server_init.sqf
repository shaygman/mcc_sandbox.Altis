...
//HandGuns
CP_handguns = [format ["%1_SERVER",missionName], "handguns", "CP_handguns", "read",[],"DEFAULT_SERVER"] call MCC_fnc_handleDB;
...
if (count CP_handguns == 0) then {
	...
	_null = [format ["%1_SERVER",missionName], "handguns", "CP_handguns", "write",CP_handguns,"DEFAULT_SERVER"] call MCC_fnc_handleDB;
};
