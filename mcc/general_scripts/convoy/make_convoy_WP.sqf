...
if !mcc_isloading then 
	...
	if (MCC_capture_state) then
		...
		MCC_capture_var = MCC_capture_var + FORMAT ["
								...
								point5 =%10;
								vip = %12;
								[[%1 select 0, %2 select 0, %3 select 0, %4 select 0, %5 select 0,%6, %7, %11 select 0,%12 select 0, %13 select 0],""MCC_fnc_placeConvoy"",true,false] spawn BIS_fnc_MP;
							    "								 
							  , convoy_car1
							  , convoy_car2
							  , convoy_car3
			...
			hint "Convoy placed";
			[[convoy_car1 select 0, convoy_car2 select 0, convoy_car3 select 0, convoy_car4 select 0, convoy_car5 select 0,_point1, _point2,[mcc_sidename] select 0, vip select 0, vipCar select 0],"MCC_fnc_placeConvoy",true,false] spawn BIS_fnc_MP;
