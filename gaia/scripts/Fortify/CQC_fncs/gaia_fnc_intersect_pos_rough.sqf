...
_eyes = eyepos _unit;
_angle = [_unit,_focus] call gaia_fnc_get_angle;


if (isnil("gaia_fnc_intersects_old")) then 
{
gaia_fnc_intersects_old = 
	{
...
_array = [_unit,_eyes,_dist] call gaia_fnc_intersects_old;
