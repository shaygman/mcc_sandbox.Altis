...
_alerter = _unit addeventhandler ["fired",
{
	...
	{
		_loudness = ([_unit,_this select 1] call gaia_gaia_fnc_silenced) * 4;
		...
		{
			_nearunits = [_unit,3,_nearunits] call gaia_gaia_fnc_Find_Closest;
		};
		
		{
			[_x,_unit] spawn gaia_fnc_cqc_react;
		} foreach _nearunits;
