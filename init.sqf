...
//-----------  Weather -------------------
MCC_weather_array = [["Clear",[0, 0, 0, 0, 0,[0,0]]], ["Clouds",[0.35, 0.25, 0.25, 0.0, 0.0,[0,0]]], ["Breeze",[0.5, 0.4, 0.4, 0.0, 0.0,[0.5,0.06]]], ["Overcast",[0.6, 0.5, 0.5, 0.0, 0.0,[0.5,0.03]]],["Rainy",[0.8, 0.8, 0.7, 0.8, 0.4,[0.5,0.03]]],["Storm",[1, 1, 1,1,1,[0.5,0.015]]], ["Storm - no rain",[1, 1, 1,0,0.1,[0.5,0.015]]]];

MCC_weather_array = [
		["Clear",			[0   , 0   , 0   , 0  , 0  , [0  ,0]    ]], 
		["Clouds",			[0.35, 0.25, 0.25, 0  , 0  , [0  ,0]    ]], 
		["Breeze",			[0.5 , 0.4 , 0.4 , 0  , 0  , [0.5,0.06] ]], 
		["Overcast",		[0.6 , 0.5 , 0.5 , 0  , 0  , [0.5,0.03] ]],
		["Rainy",			[0.8 , 0.8 , 0.7 , 0.8, 0.4, [0.5,0.03] ]],
		["Storm",			[1   , 1   , 1   , 1  , 1  , [0.5,0.015]]], 
